    ...
    <div class="row">
        ...
        <div class="col-lg-3">
            ...
            <div class="list-group">
                <a href="#" class="list-group-item">동물</a>
                <a href="#" class="list-group-item">풍경</a>
                <a href="#" class="list-group-item">꽃</a>
            </div>
        ...
        <div class="col-lg-9">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="card h-100">
                        <a href="#"><img class="card-img-top" src="img/puppy.jpg" alt="" style="height: 200px;"></a>
                        <div class="card-body">
                            <h4 class="card-title">
                                <a href="#">Item Six</a>
                            </h4>
